...
public sealed class InventoryStoreAccess(ChevrereDbContext dbContext) : IInventoryStoreAccess
{
...
public sealed class InventoryStore(ChevrereDbContext dbContext) : IInventoryStore
{
