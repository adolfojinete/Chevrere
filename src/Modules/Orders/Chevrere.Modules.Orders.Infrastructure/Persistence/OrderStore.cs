...
public sealed class OrderStoreAccess(ChevrereDbContext dbContext) : IOrderStoreAccess
{
...
public sealed class OrderStore(ChevrereDbContext dbContext) : IOrderStore
{
