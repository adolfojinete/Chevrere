...
namespace YaaJuu.Modules.Pricing.Infrastructure.Persistence;

public sealed class PricingCatalogAccess(YaaJuuDbContext dbContext) : IPricingCatalogAccess
{
...
public sealed class PricingStoreAccess(YaaJuuDbContext dbContext) : IPricingStoreAccess
{
...
public sealed class PricingStore(YaaJuuDbContext dbContext) : IPricingStore
{
