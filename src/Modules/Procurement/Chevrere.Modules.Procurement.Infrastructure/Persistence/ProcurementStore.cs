...
public sealed class ProcurementStoreAccess(ChevrereDbContext dbContext) : IProcurementStoreAccess
{
...
public sealed class ProcurementStore(ChevrereDbContext dbContext) : IProcurementStore
{
