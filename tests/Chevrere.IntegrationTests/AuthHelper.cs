...
internal static class AuthHelper
{
    ...
    public const string AdminEmail = "admin@chevrere.test";
    ...
    public static async Task<HttpClient> AuthenticatedAdminAsync(ChevrereApiFactory factory)
    {
