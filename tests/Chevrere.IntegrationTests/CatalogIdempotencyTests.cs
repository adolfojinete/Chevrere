...
public sealed class CatalogIdempotencyTests(ChevrereApiFactory factory)
{
    [Fact]
    ...
    public async Task Platform_support_can_read_catalog_but_cannot_write()
    {
        ...
        var token = await AuthHelper.LoginAsync(support, "support@chevrere.test", "SupportTest!23456");
    ...
    private async Task EnsureSupportUserAsync()
    {
        ...
        var existing = await users.FindByEmailAsync("support@chevrere.test");
        ...
        var user = new ApplicationUser
        {
            ...
            UserName = "support@chevrere.test",
            Email = "support@chevrere.test",
            EmailConfirmed = true,
