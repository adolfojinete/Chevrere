...
public sealed class EfUnitOfWorkUniqueViolationTests(ChevrereApiFactory factory)
{
    [Fact]
    ...
    public async Task Failed_store_product_enable_discards_only_loser_and_its_audit()
    {
        ...
        var winnerDb = winnerScope.ServiceProvider.GetRequiredService<ChevrereDbContext>();
