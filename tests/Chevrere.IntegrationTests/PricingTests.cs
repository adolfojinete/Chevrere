...
public sealed class PricingTests(ChevrereApiFactory factory)
{
    [Fact]
    ...
    public async Task Owner_cannot_price_foreign_store_and_support_cannot_write_global()
    {
        ...
        var token = await AuthHelper.LoginAsync(support, "support-pricing@chevrere.test", "SupportTest!23456");
    ...
    private async Task EnsureSupportUserAsync()
    {
        ...
        const string email = "support-pricing@chevrere.test";
