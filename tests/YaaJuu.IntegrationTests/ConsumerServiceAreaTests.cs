...
public sealed class ConsumerServiceAreaTests(YaaJuuApiFactory factory)
{
    [Fact]
    ...
    private const string SupportEmail = "support-consumer@yaajuu.test";
    private const string SupportPassword = "SupportTest!23456";

    private static StoreServiceArea Track(YaaJuuDbContext db, StoreServiceArea area)
    {
