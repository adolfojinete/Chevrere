...
using YaaJuu.Modules.Orders.Application.Idempotency;
...
public sealed class OrdersConcurrencyTests(YaaJuuApiFactory factory)
{
    [Fact]
        ...
        string key)
    {
        ...
        var order = Order.Place(
            ...
            [.. cart.Items.Select(i => new OrderLineSnapshot(
                ...
                YaaJuu.SharedKernel.Domain.ValueObjects.Money.Create(6500m, "COP")))],
