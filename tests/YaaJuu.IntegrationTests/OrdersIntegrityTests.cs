...
public sealed class OrdersIntegrityTests(YaaJuuApiFactory factory)
{
    [Fact]
    ...
    private static async Task AssertConstraintSqlAsync(YaaJuuDbContext db, string sql, string name)
    {
