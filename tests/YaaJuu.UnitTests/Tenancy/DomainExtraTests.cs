...
public sealed class DomainExtraTests
{
    ...
    {
        Assert.True(YaaJuu.Modules.Identity.Domain.RoleNames.IsPlatformRole("PlatformAdmin"));
        Assert.False(YaaJuu.Modules.Identity.Domain.RoleNames.IsPlatformRole("FranchiseeOwner"));
        Assert.Contains("FranchiseeOwner", YaaJuu.Modules.Identity.Domain.RoleNames.All);
    }
}
